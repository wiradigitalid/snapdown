...
| **~~`LC-022` → `sharing`~~** | Withdrawn by `DEC-020`, 2026-09-04 | `LC-022` was never built; `BUG-23` found no Slint caller for publishing at all | Not applicable — there is no boundary here to describe |
