...
| Freehand annotation like a human-audience capture tool | An arrow drawn on a picture is invisible to the reader that matters here. A numbered marker survives serialisation into text; a drawn arrow does not. Effort spent on a canvas is effort not spent on the handoff. |
